							...
							<form id="contactForm" name="contactForm" action="/contact-us/" method="post">
								<table width="580" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="176"><input type="text" name="enquiry_name" id="enquiry_name" value="{$enquiryData.enquiry_name}" placeholder="e.g. name surname" class="contact-input {if isset($errorMessages.enquiry_name)}error{/if}"></td>
									</tr>
									<tr><td colspan="2">&nbsp;</td></tr>
									<tr>
										<td width="78" >Email</td>
										<td width="245"><input type="text" name="enquiry_email" id="enquiry_email" value="{$enquiryData.enquiry_email}" placeholder="e.g. name@domain.com"  class="contact-input {if isset($errorMessages.enquiry_email)}error{/if}"></td>								
									</tr>
									<tr><td colspan="2">&nbsp;</td></tr>
									<tr>
										<td width="78" >Number</td>
										<td width="245"><input type="text" name="enquiry_number" id="enquiry_number" value="{$enquiryData.enquiry_number}" placeholder="e.g. 0735654825" class="contact-input {if isset($errorMessages.enquiry_number)}error{/if}"></td>								
									</tr>	
									<tr><td colspan="2">&nbsp;</td></tr>									
									<tr>
										<td>Message</td>
										<td><textarea rows="10" name="enquiry_comments" id="enquiry_comments" value="{$enquiryData.enquiry_comments}" class="contact-message {if isset($errorMessages.enquiry_comments)}error{/if}"></textarea></td>
									</tr>
									<tr><td colspan="2">&nbsp;</td></tr>
									<tr>
										<td></td>
