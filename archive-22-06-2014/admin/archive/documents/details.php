...
if(count($_POST) > 0) {
	...
	if(count($errorArray) == 0 && $formValid == true) {
		...
		if(isset($_FILES['documentFile'])) { 
			...
			$oldext		= isset($documentData['document_filepath']) ? $fileObject->file_extention($documentData['document_filepath']) : $fileObject->file_extention($_FILES['documentFile']['name']) ;		
