...
if(count($_POST) > 0) {
	...
	if(isset($_POST['statusbutton']) && (int)trim($_POST['statusbutton']) == 3 && isset($serviceData)) {
		/* Delete account. */
		$data['service_deleted']	= 1;
	...
	if(count($errorArray) == 0 && $formValid == true) {
		...
		$data['service_active']				= (int)trim($_POST['statusbutton']) == 1 ? 1 : 0;		
