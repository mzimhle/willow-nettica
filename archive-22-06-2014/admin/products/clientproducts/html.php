...
$clientData = $clientObject->getPaginated($filter,'client.client_added DESC', $currentPage, $perPage, $listedPages, $scrollingStyle);
 
$clientItems = $clientData->getCurrentItems();

$smarty->assign_by_ref('clientItems', $clientItems);

$paginator = $clientData->setView()->getPages();
...
/* display template */
$smarty->display('admin/shop/clientproduct/html.tpl');
