						...
						<table cellspacing="0" cellpadding="0" border="0" class="all"> 
							...
							<tbody>
								  ...
								  <tr>
									...
									<td align="left" class="alt"><a href="/admin/products/invoices/details.php?reference={$item.invoice_reference}">{$item.invoice_reference}</a></td>	
									...
									<td align="left" class="alt"><a href="{$item.invoice_file}" target="_blank">html</a> | <a href="download.php?reference={$item.invoice_reference}" target="_blank">pdf</a></td>
								  </tr>
								  {/foreach}    
							</tbody>
						</table>
