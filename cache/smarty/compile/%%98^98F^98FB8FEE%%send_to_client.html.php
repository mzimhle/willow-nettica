<?php /* Smarty version 2.6.20, created on 2013-07-09 21:24:51
         compiled from mailers/invoice/send_to_client.html */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<!-- saved from url=(0071)https://willownettica.createsend.com/templates/preview/3753CC296D3CB5A6 -->
                ...
                <repeater>
                    ...
                    <layout label="Text only">
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <p align="left" class="article-title"><?php echo $this->_tpl_vars['title']; ?>
</p>
                                    <div align="left" class="article-content">
                                        <b>Good day <?php echo $this->_tpl_vars['clientname']; ?>
</b><br /><br />
                    ...
                    <layout label="Text only">
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <p align="left" class="article-title">Bank Details:</p>
                                    <div align="left" class="article-content">
Payments to be made to: </p>
		  ...
		  Branch Code: 020909<br />
                    ...
                    <layout label="Text only">
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <p align="left" class="article-title">Contact Details</p>
                                    <div align="left" class="article-content">
