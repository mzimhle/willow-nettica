<?php /* Smarty version 2.6.20, created on 2013-09-25 23:00:53
         compiled from feeds/contact-us/default.tpl */ ?>
<!DOCTYPE html>
<!-- HTML Start -->
<html lang="en">
<!-- Page Head Start -->
							...
							<form id="contactForm" name="contactForm" action="/feeds/contact-us/" method="post">
								<table width="580" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="176"><input type="text" name="enquiry_name" id="enquiry_name" value="" placeholder="e.g. Name Surname" class="contact-input <?php if (isset ( $this->_tpl_vars['errorMessages']['enquiry_name'] )): ?>error<?php endif; ?>"></td>
									</tr>
									<tr><td colspan="2">&nbsp;</td></tr>
									<tr>
										<td width="78" >Email</td>
										<td width="245"><input type="text" name="enquiry_email" id="enquiry_email" value="" placeholder="e.g. name.surname@domain.com"  class="contact-input <?php if (isset ( $this->_tpl_vars['errorMessages']['enquiry_email'] )): ?>error<?php endif; ?>"></td>								
									</tr>
									<tr><td colspan="2">&nbsp;</td></tr>
									<tr>
										<td width="78" >Number</td>
										<td width="245"><input type="text" name="enquiry_number" id="enquiry_number" value="" placeholder="e.g. 0735654825" class="contact-input <?php if (isset ( $this->_tpl_vars['errorMessages']['enquiry_number'] )): ?>error<?php endif; ?>"></td>								
									</tr>	
									<tr><td colspan="2">&nbsp;</td></tr>									
									<tr>
										<td>Message</td>
										<td><textarea rows="10" name="enquiry_comments" id="enquiry_comments" value="" class="contact-message <?php if (isset ( $this->_tpl_vars['errorMessages']['enquiry_comments'] )): ?>error<?php endif; ?>"></textarea></td>
									</tr>
									<tr><td colspan="2">&nbsp;</td></tr>
									<tr>
										<td></td>
