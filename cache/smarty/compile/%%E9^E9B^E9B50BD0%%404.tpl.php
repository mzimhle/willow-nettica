<?php /* Smarty version 2.6.20, created on 2014-04-22 08:17:17
...
<!--[if gt IE 8]><!--> <html class="no-js" xmlns:fb="http://ogp.me/ns/fb#"> <!--<![endif]-->
    <head>
		...
		<title>Willow-Nettica - Page Not Found</title>
		...
		<meta property="og:description" content="Willow-Nettica : Page not found">
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
  	...
  	<div class="container" >
    <div class="span12">
    	<div class="title"><h2>Page Not Found</h2></div>
    	<div class="fluidrow">
			<div class="sub-title"><h3>404 Error Message</h3></div>
			<p>The page you are looking for has not been found, please check out menu to see if you will be able to see what you are looking for.</p>
		</div>
    </div>
    	</div>
	</section> 
