<?php /* Smarty version 2.6.20, created on 2013-09-09 12:06:28
         compiled from mailers/invoice/invoice.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mailers/invoice/invoice.html', 38, false),)), $this); ?>
<!DOCTYPE html>
	...
	<div id="page-wrap">
		...
		<div id="identity">
            <p id="address" style="width: 400px !important;">
				...
				Cell: <?php echo $this->_tpl_vars['client']['client_contact_cell']; ?>
 / Tel: <?php echo $this->_tpl_vars['client']['client_contact_telephone']; ?>
<br />
				Email: <?php echo $this->_tpl_vars['client']['client_contact_email']; ?>
<br />
			</p>
            <div class="logo">
				<table width="320px">
