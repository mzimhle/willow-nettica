<?php /* Smarty version 2.6.20, created on 2013-06-28 09:56:04
         compiled from admin/products/invoices/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/products/invoices/default.tpl', 52, false),)), $this); ?>
...
?>
								  <tr>
									...
									<td align="left" class="alt"><a href="/admin/products/invoices/details.php?reference=<?php echo $this->_tpl_vars['item']['invoice_reference']; ?>
"><?php echo $this->_tpl_vars['item']['invoice_reference']; ?>
</a></td>	
									<td align="left" class="alt"><?php echo $this->_tpl_vars['item']['client_company']; ?>
</td>
									<td align="left" class="alt"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['client_payment_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
									...
									<td align="left" class="alt"><?php if ($this->_tpl_vars['item']['invoice_paid'] == 1): ?><span style="color: green;">Paid</span><?php else: ?><span style="color: red;">Not Paid</span><?php endif; ?></td>
									<td align="left" class="alt"><a href="<?php echo $this->_tpl_vars['item']['invoice_file']; ?>
" target="_blank">html</a> | <a href="download.php?reference=<?php echo $this->_tpl_vars['item']['invoice_reference']; ?>
