<?php /* Smarty version 2.6.20, created on 2013-11-10 13:13:39
         compiled from admin/invoices/create/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/invoices/create/default.tpl', 41, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8" /> 
	<title>Admin | Invoices | Create an invoice</title>
		...
		<div id="right">
			...
			<div class="section">
				<div class="box">
					...
					<div class="content">
						<form name="invoiceForm" id="invoiceForm" action="/admin/invoices/create/" method="post">
							<div class="row">
								<label>Client</label>
								<div class="right">
...
?>
							...
							<div class="row">
							<form name="itemsForm" id="itemsForm" action="/admin/invoices/create/" method="post">
